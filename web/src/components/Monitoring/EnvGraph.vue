...
const chartData = {
  series: [
    ...
    {
      name: 'DISK',
      data: [35, 31, 36, 30, 31, 35, 36, 31, 35, 36, 31, 30]
    },
    {
      name: 'NET',
      data: [41, 43, 44, 48, 49, 45, 51, 50, 48, 43, 31, 15]
    }
  ],
...
const apexOptions = {
  ...
  colors: ['#3056D3', '#80CAEE', '#0d9488', '#f59e0b'],
  chart: {
  ...
  markers: {
    size: 4,
    colors: '#fff',
    strokeColors: ['#3056D3', '#80CAEE', '#0d9488', '#f59e0b'],
    strokeWidth: 3,
    strokeOpacity: 0.9,
    strokeDashArray: 0,
    fillOpacity: 1,
...
<template>
  <div
      class="col-span-12 xl:col-span-8 rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 "
  >
      ...
      <div class="flex w-full flex-wrap gap-3 sm:gap-5">
        ...
        <div class="flex min-w-47.5">
          <span
              class="mt-1 mr-2 flex h-4 w-full max-w-4 items-center justify-center rounded-full border border-secondary"
          >
            <span class="block h-2.5 w-full max-w-2.5 rounded-full bg-teal-600"></span>
          </span>
          <div class="w-full">
        ...
        <div class="flex min-w-47.5">
          <span
              class="mt-1 mr-2 flex h-4 w-full max-w-4 items-center justify-center rounded-full border border-secondary"
          >
            <span class="block h-2.5 w-full max-w-2.5 rounded-full bg-amber-500"></span>
          </span>
          <div class="w-full">
