  ...
  <div>
    <label :for="props.id" class="flex cursor-pointer select-none items-center">
      <div class="relative">
        ...
        <div
            :class="switcherToggle && '!right-1 !translate-x-full !bg-success dark:!bg-white'"
            class="dot absolute left-1 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-red transition"
        >
          ...
          <span :class="switcherToggle && 'hidden'" class="text-white dark:text-bodydark">
            <svg
